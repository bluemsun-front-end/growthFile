        ...
        <div class="background1">
            <el-tabs tabPosition="top" type="border-card" style="height: 90vh;border:none" class="demo-tabs">
                ...
                <el-tab-pane label="个人处分" class="biaoge,tab-content">
                  ...
                  >
                    <template #empty>
                      <div style="width:1000px;" class="flex items-center justify-center h-100%">
                        <el-empty />
                      </div>
                    </template>
                  </el-table-v2>
                ...
                <el-tab-pane label="个人奖励"  class="biaoge,tab-content1">
                ...
                <el-tab-pane label="社会经历" class="tab-content">
                        ...
                        <div class="change2">
                          ...
                          <div class="changeInfor2">
                            ...
                            <el-input
                              ...
                              style="resize:none;margin-top:10px;width: 600px"
                              :rows="2"
                              type="textarea"
                  ...
                  <el-table ref="tableRef" row-key="userId" :data="socialExperienceData" style="width: 100%"  >
                    ...
                    <el-table-column prop="startDate" label="Start Date" width="250" sortable/>
                    <el-table-column prop="endDate" label="End Date" width="250" sortable/>
...
const saveEditInfo = async () => {
  if (editForm.value) {
    ...
    //         console.log(editInfo.value.birthday);
    //         // 发送请求
    //         const response = await axios.post('http://106.54.24.243:8080/grow/userInfo/updateUserInfo', dataToSubmit);
    //         if (response.data.code === 200) {
